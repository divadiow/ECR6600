...
*/
 ...
 @details  When calibrating, only need to call AUX ADC for measurement at room temperature 27¡æ, and save 8bits data in EFUSE.
			 As a function of voltage-temperature : Temp*0.002 + X =ts_data_pa*0.003125 ,Where ts_data_pa is the voltage value 
			 corresponding to 27¡ã. X represents the voltage value corresponding to the current temperature.Temp represents 
...
@details  During calibration, it is necessary to call AUX ADC for measurement at room temperature 27¡ãC 
			and high temperature 80¡ãC and save 2x8bits data in EFUSE. 
...
*/
 ...
 unsigned int get_current_temprature();
