...
#define OTA_UPDATE_ACTIVE_PARTA 0x1
#define OTA_UPDATE_ACTIVE_PARTB 0x2
...
typedef struct {
    ...
    unsigned char update_method;
    unsigned char head_frame_done;
    unsigned int image_start_addr;
    unsigned int image_end_addr;
    unsigned int image_size;
    unsigned int image_offset;
    unsigned int boot_start_addr;
    unsigned int boot_end_addr;
    unsigned int boot_size;
    unsigned int boot_offset;
    unsigned int erase_offset;
    unsigned int offset;
    unsigned int partition_cpu_addr;
    unsigned int partition_cpu_len;
    unsigned int partition_ota_status_addr;
    unsigned int partition_ota_status_len;
} ota_opinfo_t;
