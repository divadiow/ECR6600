...
{ 
    ...
    return drv_wdt_start(ctrl_int_para, ctrl_rst_para, WDT_CTRL_INTENABLE, WDT_CTRL_RSTENABLE);
}

WDT_RET_CODE hal_wdt_start() 
{
    return drv_wdt_start(WDT_CTRL_INTTIME_7, WDT_CTRL_RSTTIME_7, WDT_CTRL_INTENABLE, WDT_CTRL_RSTENABLE);;
}
