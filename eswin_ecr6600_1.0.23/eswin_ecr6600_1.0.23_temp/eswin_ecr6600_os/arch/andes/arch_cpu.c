...
static void _nds32_start_PFM(void)
{
	unsigned int val = 0;

	/* Init performance counter0 */
	__nds32__mtsr_dsb(val, NDS32_SR_PFMC0);

	/* Enable performance counter0£¬and Calculate Cycles for counter0 */
	val |= (PFM_CTL_mskEN0);
