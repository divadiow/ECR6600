...
#define wpa_printf(x, ...) do {if (x >= wpa_debug_level) os_printf(LM_APP, LL_INFO, __VA_ARGS__);if (x >= wpa_debug_level) os_printf(LM_APP, LL_INFO, "\n");}while (0)
...
#define wpa_dbg(x, y, ...) do {if (y >= wpa_debug_level) os_printf(LM_APP, LL_INFO, __VA_ARGS__);if (y >= wpa_debug_level) os_printf(LM_APP, LL_INFO, "\n");}while (0)
