...
char ** wpa_config_get_all(struct wpa_ssid *ssid, int get_keys)
{
	...
	get_keys = get_keys && 0/*ssid->export_keys*/;
...
{
#ifndef CONFIG_NO_PBKDF2
	wpa_printf(MSG_DEBUG, "[time]<pbkdf2_sha1>");
    //extern int wifi_use_nv_pmk(char *ssid, char *pwd, uint8_t *pmk);
    if (1/*!wifi_use_nv_pmk((char *)ssid->ssid, ssid->passphrase, ssid->psk)*/) {
